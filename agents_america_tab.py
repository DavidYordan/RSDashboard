...
class AgentsAmericaTab(QWidget):
    ...
    async def update_agents_worker(self):
        ...
        while True:
            try:
                ...
                res = requests.get(f'{self.url_base}/sqx_fast/agent/agent/list?page={page}&limit={500}', headers=self.headers)
    ...
    def setup_ui(self):
        ...
        button_update = QPushButton('Update Agents')
    ...
    def update_agents(self):
        ...
        Globals.run_async_task(self.update_agents_worker)
